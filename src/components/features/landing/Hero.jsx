...
import { STAGGER_CHILD_VARIANTS } from "@/lib/motion.js";
                            ...
                            <span className="flex">
                                {"Code.".split("").map((char, i) => (
                                    <motion.span
                                        ...
                                        initial={{ opacity: 0 }}
                                        animate={{ opacity: 1 }}
                                        transition={{ duration: 0, delay: i * 0.1 + 0.5 }}
                            ...
                            <span className="flex">
                                {"Compete.".split("").map((char, i) => (
                                    <motion.span
                                        ...
                                        initial={{ opacity: 0 }}
                                        animate={{ opacity: 1 }}
                                        transition={{ duration: 0, delay: i * 0.1 + 1.2 }}
                            ...
                            <span className="flex">
                                {"Conquer.".split("").map((char, i) => (
                                    <motion.span
                                        ...
                                        initial={{ opacity: 0 }}
                                        animate={{ opacity: 1 }}
                                        transition={{ duration: 0, delay: i * 0.1 + 2.2 }}
                                        className="text-neutral-300"
                                    >
                                        {char}
                                    </motion.span>
